  ...
  <div>
    ...
    <div v-if="!online" class="offline">
      ...
      >
        ...
        <g
          id="SvgjsG1013"
          transform="matrix(0.9167,0,0,0.9167,12.00258126707078,11.99605319709778)"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
export default Vue.extend({
  ...
  mounted() {
    ...
    window.console.log(
      '%cDANGER!',
      'color:red;font-size:xx-large;font-weight:bold;font-family:Press Start 2P;'
    )
    window.console.log(
      '%cIts not allow to you inject code here, its not good for me :)!',
      'color:red;font-weight:bold;font-family:Press Start 2P;'
    )
